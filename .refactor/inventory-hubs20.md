...
## Hub symbols (highest fan-in; removed before clustering: 20)
...
- after removing 20 hubs: 9 components, largest has 212 of 222 defs
...
### Community 1: 6780 LOC, 78 symbols; in-edges from 11 outside symbols, out-edges to 10
- members: `_exclusive_descriptor_lock`, `_chain_storage_root`, `_merge_history_uses_additive_grammar`, `_merge_ingest_transition_valid`, `_merge_current_authority_valid`, `_ChainActivationSnapshot`, `_resolve_chain_activation_snapshot`, `_resolve_chain_activation_projection`, `_chain_activation_ownership_summary`, `_validate_chain_activation_lineage`, `_require_no_pending_chain_activation_outbox`, `_prepare_merge_activation_preamble`, `_authorize_chain_batch`, `_merge_ingest_binding`, `_merge_gate_event_fact`, `_merge_ingest_record_templates`, `_ingest_proof_verifier`, `register_activation_reservation_seam`, `register_coordination_seams`, `_coordination_refusal`, `_validate_chain_batch_target`, `_chain_batch_lock`, `parse_time`, `validate_state`, `_require_merge_store_control`, `validate_merge_state`, `MergeReplayResult`, `_replay_merge_event_bytes`, `_drain_chain_batch_capability`, `_ChainStoragePrimitives`, `_build_merge_chain_journal_records`, `_new_merge_record_is_current`, `MergeChainStore`, `CommonLockUnavailable`, `ChainLeaseUnavailable`, `_valid_host`, `_validate_chain_lease_record`, `_write_all`, `_open_owned_directory`, `_PublicationCleanupFailure` ...
### Community 2: 3426 LOC, 36 symbols; in-edges from 4 outside symbols, out-edges to 11
- members: `_validated_commitment_path`, `_require_ingest_proof`, `_merge_ingest_state_shape_valid`, `_prevalidate_chain_batch_carrier`, `_read_ingest_input`, `_capture_ingest_blob`, `_capture_run_evidence`, `_capture_ingest_record_evidence`, `_ingest_captured_paths`, `_ingest_step_is_current`, `_ingest_secret_scan_is_current`, `_prove_ingest_live_chain`, `_merge_current_gate_facts`, `_ingest_allocation_records`, `_verify_and_build_merge_ingest_records`, `_verify_and_build_ingest_records`, `candidate_is_v2`, `_event_batch_records_with_candidate_v2`, `_binding_matches_source_fact_with_candidate_v2`, `_binding_is_current_with_candidate_v2`, `_commit_transition_valid_with_candidate_v2`, `Repository`, `_committed_changelog_output_paths`, `_require_merge_adapter_control`, `ChainStore`, `CLIOptions`, `CommandContext`, `_policy_for_state`, `_validate_bound_chain_state`, `_latest_current_pass`, `_user_skip`, `_gate_satisfied`, `_fresh_reviewer_evals_required`, `_required_steps`, `_gate_one_complete`, `_forge_command`
### Community 3: 2971 LOC, 18 symbols; in-edges from 3 outside symbols, out-edges to 20
...
### Community 6: 783 LOC, 11 symbols; in-edges from 0 outside symbols, out-edges to 6
- members: `CommonLockReleaseFailure`, `FencedChildSurvived`, `_BlockedFenceChild`, `_pipe_cloexec`, `_spawn_blocked_fence_child`, `_waitpid_nohang`, `_wait_for_child_exit`, `_terminate_fenced_group`, `_stop_unstarted_child`, `_collect_fenced_child`, `run_fenced_command`
### Community 7: 402 LOC, 6 symbols; in-edges from 2 outside symbols, out-edges to 1
...
### Community 8: 382 LOC, 6 symbols; in-edges from 3 outside symbols, out-edges to 4
- members: `CommonLockInspection`, `_validate_owner_record`, `_open_lock_directory`, `_inspect_common_lock_fd`, `_publish_portable_owner`, `_release_portable_identity`
### Community 9: 333 LOC, 7 symbols; in-edges from 1 outside symbols, out-edges to 0
...
### Community 10: 204 LOC, 5 symbols; in-edges from 4 outside symbols, out-edges to 0
