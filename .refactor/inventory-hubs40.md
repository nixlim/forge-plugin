...
## Hub symbols (highest fan-in; removed before clustering: 40)
...
- after removing 40 hubs: 12 components, largest has 189 of 202 defs
...
### Cluster 1: 17156 LOC, 189 symbols
...
- referenced from outside cluster by: CommandContext, CommonRebaseLock, RecoveryReservation, _create_private_record_at, _inspect_common_lock_fd, _merge_state_shape_valid, _release_portable_identity
- references outside cluster: CHAIN_ID_RE, CHAIN_TOMBSTONE_EVENT, CHAIN_TOMBSTONE_KEYS, CHAIN_TOMBSTONE_SCHEMA, COMMIT_RE, COMMON_LOCK_DIRECTORY_NAME, COMMON_LOCK_FENCE_OPERATIONS, COMMON_LOCK_FLOCK_NAME, COMMON_LOCK_INFLIGHT_NAME, COMMON_LOCK_INTENT_NAME, COMMON_LOCK_OWNER_NAME, COMMON_LOCK_POLL_SECONDS, COMMON_LOCK_RECOVERY_NAME, COMMON_LOCK_TIMEOUT_SECONDS, CommandContext
### Cluster 2: 102 LOC, 2 symbols
- members: `_merge_gate_plan_valid`, `_merge_epoch_valid`
- referenced from outside cluster by: _merge_state_shape_valid
- references outside cluster: SHA256_RE, _valid_nonce, _valid_utc_second, canonical_bytes
### Cluster 3: 99 LOC, 1 symbols
- members: `_merge_payload_delta`
- referenced from outside cluster by: reduce_merge_event
- references outside cluster: none

## Communities (label propagation on the hub-free graph; use when a component is still too big)
### Community 1: 5081 LOC, 37 symbols; in-edges from 4 outside symbols, out-edges to 10
- members: `_exclusive_descriptor_lock`, `_require_ingest_proof`, `_merge_ingest_state_shape_valid`, `_prevalidate_chain_batch_carrier`, `_read_ingest_input`, `_capture_ingest_record_evidence`, `_ingest_captured_paths`, `_ingest_step_is_current`, `_ingest_secret_scan_is_current`, `_prove_ingest_live_chain`, `_merge_current_gate_facts`, `_ingest_allocation_records`, `_verify_and_build_merge_ingest_records`, `_verify_and_build_ingest_records`, `_coordination_refusal`, `candidate_is_v2`, `_event_batch_records_with_candidate_v2`, `_binding_matches_source_fact_with_candidate_v2`, `_binding_is_current_with_candidate_v2`, `_commit_transition_valid_with_candidate_v2`, `Repository`, `_committed_changelog_output_paths`, `validate_state`, `_drain_chain_batch_capability`, `_ChainStoragePrimitives`, `ChainStore`, `_write_all`, `_open_owned_directory`, `_acquire_secondary_flock`, `hold_common_lock`, `CLIOptions`, `_validate_bound_chain_state`, `_latest_current_pass`, `_user_skip`, `_gate_satisfied`, `_gate_one_complete`, `_forge_command`
### Community 2: 3114 LOC, 21 symbols; in-edges from 4 outside symbols, out-edges to 18
- members: `_merge_ingest_transition_valid`, `_merge_carried_gate_steps`, `_merge_gate_step_generation_digests`, `_epoch_fetch_observation_predecessor_valid`, `_recovered_absent_rebase_intent_digest`, `_merge_transition_valid`, `_require_merge_integration_control`, `_merge_rebase_action`, `_merge_rebase_result_classification`, `_merge_latest_contained_attempt`, `_merge_inactive_post_attempt_recovery_ready`, `_epoch_fetch_observation_record_valid`, `_epoch_fetch_observation_passed`, `_epoch_fetch_result_intent_digest`, `_epoch_ancestry_record_valid`, `_remote_observation_progress_transition_valid`, `_remote_observation_progress_matches_observed`, `_replayed_remote_observation_completed`, `_bootstrap_fetch_observation_record_valid`, `_bootstrap_fetch_observation_transition_valid`, `_merge_candidate_observation_evidence_valid`
### Community 3: 2031 LOC, 22 symbols; in-edges from 3 outside symbols, out-edges to 10
- members: `validate_merge_state`, `MergeReplayResult`, `_replay_merge_event_bytes`, `_new_merge_record_is_current`, `MergeChainStore`, `ChainLeaseUnavailable`, `_validate_chain_lease_record`, `_record_at_if_present`, `_process_probe`, `_fence_death_proof`, `_require_recovery_proof_recorder`, `_persist_recovery_proof`, `_recovery_classification_receipt_valid`, `_read_fence_for_recovery`, `_recover_stale_portable_owner`, `_clear_reserved_fence`, `ChainLease`, `_lease_exclusion_is_current`, `_lease_reclaim_authority_is_current`, `_repository_recovery_reservation_present`, `_reconcile_merge_projection_for_lease_reclaim`, `acquire_chain_lease`
### Community 4: 1155 LOC, 19 symbols; in-edges from 3 outside symbols, out-edges to 0
...
### Community 5: 1119 LOC, 14 symbols; in-edges from 5 outside symbols, out-edges to 2
- members: `_chain_storage_root`, `_ChainActivationSnapshot`, `_resolve_chain_activation_snapshot`, `_resolve_chain_activation_projection`, `_chain_activation_ownership_summary`, `_validate_chain_activation_lineage`, `_require_no_pending_chain_activation_outbox`, `_prepare_merge_activation_preamble`, `_authorize_chain_batch`, `_ingest_proof_verifier`, `register_activation_reservation_seam`, `register_coordination_seams`, `_validate_chain_batch_target`, `_chain_batch_lock`
### Community 6: 845 LOC, 12 symbols; in-edges from 2 outside symbols, out-edges to 2
...
### Community 7: 767 LOC, 10 symbols; in-edges from 2 outside symbols, out-edges to 9
- members: `CommonLockUnavailable`, `_group_probe`, `_new_owner_record`, `_fence_matches_owner`, `_publish_recovery_reservation`, `_reservation_evidence`, `_clear_owned_reservation`, `_recovery_record`, `_common_fence_path_present`, `acquire_common_lock`
### Community 8: 688 LOC, 10 symbols; in-edges from 0 outside symbols, out-edges to 5
- members: `CommonLockReleaseFailure`, `FencedChildSurvived`, `_PublicationCleanupFailure`, `_pipe_cloexec`, `_read_child_ack`, `_spawn_blocked_fence_child`, `_wait_for_child_exit`, `_stop_unstarted_child`, `_publish_fence`, `run_fenced_command`
### Community 9: 402 LOC, 6 symbols; in-edges from 2 outside symbols, out-edges to 1
- members: `_merge_attempted_release_preconditions_valid`, `_merge_cleanup_evidence_history`, `_merge_cleanup_history_summary`, `_merge_release_preconditions_valid`, `_merge_containment`, `_merge_old_tip_all_false`
### Community 10: 354 LOC, 4 symbols; in-edges from 2 outside symbols, out-edges to 1
...
### Community 12: 207 LOC, 3 symbols; in-edges from 2 outside symbols, out-edges to 0
- members: `_waitpid_nohang`, `_terminate_fenced_group`, `_collect_fenced_child`
### Community 13: 204 LOC, 5 symbols; in-edges from 4 outside symbols, out-edges to 0
...
### Community 14: 164 LOC, 3 symbols; in-edges from 1 outside symbols, out-edges to 1
