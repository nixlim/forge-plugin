...
### Vendored engine behavior (FR-010..FR-016)
...
| FR-010..FR-016 | Vendored engine | Upstream-compatible validation (Happy), Disjoint run admitted/overlap refused (Edge), Declared legacy journal demotes pre-declaration dialect issues to warnings (Edge) | Integration: vendored suite, migrated doc-contract, registry admission, real legacy-prefix acceptance; Unit: baseline validate, per-leg disable detection |
